...
int main(int argc, char** argv) {
	...
	// width and height discribes the whole picture.
	// startrow=0, totalRows=height/2, draws the upper half.
	// startRow=height/2, totalRows=height/2, draws the lower half.
